...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Embodied cognition, and where does it fail?

## Kuhn Review Anchor
- Section: 9.6.1. Embodied cognition
- Pages: 37-37
- Taxonomy placement: Materialism theories -> Embodied and enactive theories -> Embodied cognition
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Embodied and enactive theories -> Embodied cognition.
...
## Related Packets
- Adjacent packets in Materialism theories -> Embodied and enactive theories -> Embodied cognition
...
## Sources
- Kuhn review, section 9.6.1, pages 37-37.
