# Qualia Research Institute’s state-space, qualia formalism, valence

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Qualia Research Institute’s state-space, qualia formalism, valence, and where does it fail?

## Kuhn Review Anchor
- Section: 14.10. Qualia Research Institute’s state-space, qualia formalism, valence
- Pages: 82-82
- Taxonomy placement: Monisms -> Qualia Research Institute’s state-space, qualia formalism, valence
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Monisms -> Qualia Research Institute’s state-space, qualia formalism, valence.
...
## Related Packets
- Adjacent packets in Monisms -> Qualia Research Institute’s state-space, qualia formalism, valence
...
## Sources
- Kuhn review, section 14.10, pages 82-82.
