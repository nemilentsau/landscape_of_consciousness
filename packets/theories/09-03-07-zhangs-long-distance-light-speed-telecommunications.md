...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Zhang’s long-distance light-speed telecommunications, and where does it fail?

## Kuhn Review Anchor
- Section: 9.3.7. Zhang’s long-distance light-speed telecommunications
- Pages: 28-28
- Taxonomy placement: Materialism theories -> Electromagnetic field theories -> Zhang’s long-distance light-speed telecommunications
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Electromagnetic field theories -> Zhang’s long-distance light-speed telecommunications.
...
## Related Packets
- Adjacent packets in Materialism theories -> Electromagnetic field theories -> Zhang’s long-distance light-speed telecommunications
...
## Sources
- Kuhn review, section 9.3.7, pages 28-28.
