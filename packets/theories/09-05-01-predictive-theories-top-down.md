...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Predictive theories (Top-down), and where does it fail?

## Kuhn Review Anchor
- Section: 9.5.1. Predictive theories (Top-down)
- Pages: 32-32
- Taxonomy placement: Materialism theories -> Homeostatic and affective theories -> Predictive theories (Top-down)
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Homeostatic and affective theories -> Predictive theories (Top-down).
...
## Related Packets
- Adjacent packets in Materialism theories -> Homeostatic and affective theories -> Predictive theories (Top-down)
...
## Sources
- Kuhn review, section 9.5.1, pages 32-32.
