# Nader’s all there is

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Nader’s all there is, and where does it fail?

## Kuhn Review Anchor
- Section: 16.11. Nader’s all there is
- Pages: 101-101
- Taxonomy placement: Idealisms -> Nader’s all there is
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Idealisms -> Nader’s all there is.
...
## Related Packets
- Adjacent packets in Idealisms -> Nader’s all there is
...
## Sources
- Kuhn review, section 16.11, pages 101-101.
