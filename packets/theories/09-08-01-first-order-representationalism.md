...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for First-order representationalism, and where does it fail?

## Kuhn Review Anchor
- Section: 9.8.1. First-order representationalism
- Pages: 43-43
- Taxonomy placement: Materialism theories -> Representational theories -> First-order representationalism
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Representational theories -> First-order representationalism.
...
## Related Packets
- Adjacent packets in Materialism theories -> Representational theories -> First-order representationalism
...
## Sources
- Kuhn review, section 9.8.1, pages 43-43.
