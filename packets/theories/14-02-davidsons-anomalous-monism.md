...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Davidson’s anomalous monism, and where does it fail?

## Kuhn Review Anchor
- Section: 14.2. Davidson’s anomalous monism
- Pages: 78-78
- Taxonomy placement: Monisms -> Davidson’s anomalous monism
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Monisms -> Davidson’s anomalous monism.
...
## Related Packets
- Adjacent packets in Monisms -> Davidson’s anomalous monism
...
## Sources
- Kuhn review, section 14.2, pages 78-78.
