# Graboi’s three-aspect model

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Graboi’s three-aspect model, and where does it fail?

## Kuhn Review Anchor
- Section: 17.11. Graboi’s three-aspect model
- Pages: 111-111
- Taxonomy placement: Anomalous and altered states theories -> Graboi’s three-aspect model
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Anomalous and altered states theories -> Graboi’s three-aspect model.
...
## Related Packets
- Adjacent packets in Anomalous and altered states theories -> Graboi’s three-aspect model
...
## Sources
- Kuhn review, section 17.11, pages 111-111.
