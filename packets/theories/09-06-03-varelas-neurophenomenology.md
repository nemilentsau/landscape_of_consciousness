...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Varela ’ s neurophenomenology, and where does it fail?

## Kuhn Review Anchor
- Section: 9.6.3. Varela ’ s neurophenomenology
- Pages: 38-38
- Taxonomy placement: Materialism theories -> Embodied and enactive theories -> Varela ’ s neurophenomenology
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Embodied and enactive theories -> Varela ’ s neurophenomenology.
...
## Related Packets
- Adjacent packets in Materialism theories -> Embodied and enactive theories -> Varela ’ s neurophenomenology
...
## Sources
- Kuhn review, section 9.6.3, pages 38-38.
