# Tegmark’s state of matter

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Tegmark’s state of matter, and where does it fail?

## Kuhn Review Anchor
- Section: 14.9. Tegmark’s state of matter
- Pages: 81-81
- Taxonomy placement: Monisms -> Tegmark’s state of matter
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Monisms -> Tegmark’s state of matter.
...
## Related Packets
- Adjacent packets in Monisms -> Tegmark’s state of matter
...
## Sources
- Kuhn review, section 14.9, pages 81-81.
