...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Langan ’ s cognitive-theoretic model of the universe, and where does it fail?

## Kuhn Review Anchor
- Section: 17.19. Langan ’ s cognitive-theoretic model of the universe
- Pages: 115-115
- Taxonomy placement: Anomalous and altered states theories -> Langan ’ s cognitive-theoretic model of the universe
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Anomalous and altered states theories -> Langan ’ s cognitive-theoretic model of the universe.
...
## Related Packets
- Adjacent packets in Anomalous and altered states theories -> Langan ’ s cognitive-theoretic model of the universe
...
## Sources
- Kuhn review, section 17.19, pages 115-115.
