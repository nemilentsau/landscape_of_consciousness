...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Graziano’s attention schema theory, and where does it fail?

## Kuhn Review Anchor
- Section: 9.2.6. Graziano’s attention schema theory
- Pages: 23-23
- Taxonomy placement: Materialism theories -> Neurobiological theories -> Graziano’s attention schema theory
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Neurobiological theories -> Graziano’s attention schema theory.
...
## Related Packets
- Adjacent packets in Materialism theories -> Neurobiological theories -> Graziano’s attention schema theory
...
## Sources
- Kuhn review, section 9.2.6, pages 23-23.
