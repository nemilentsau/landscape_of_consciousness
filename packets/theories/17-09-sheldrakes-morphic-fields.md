...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Sheldrake’s morphic fields, and where does it fail?

## Kuhn Review Anchor
- Section: 17.9. Sheldrake’s morphic fields
- Pages: 110-110
- Taxonomy placement: Anomalous and altered states theories -> Sheldrake’s morphic fields
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Anomalous and altered states theories -> Sheldrake’s morphic fields.
...
## Related Packets
- Adjacent packets in Anomalous and altered states theories -> Sheldrake’s morphic fields
...
## Sources
- Kuhn review, section 17.9, pages 110-110.
