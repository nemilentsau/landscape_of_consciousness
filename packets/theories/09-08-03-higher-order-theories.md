...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Higher-order theories, and where does it fail?

## Kuhn Review Anchor
- Section: 9.8.3. Higher-order theories
- Pages: 45-45
- Taxonomy placement: Materialism theories -> Representational theories -> Higher-order theories
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Representational theories -> Higher-order theories.
...
## Related Packets
- Adjacent packets in Materialism theories -> Representational theories -> Higher-order theories
...
## Sources
- Kuhn review, section 9.8.3, pages 45-45.
