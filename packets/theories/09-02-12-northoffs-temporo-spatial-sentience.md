...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Northoff’s temporo-spatial sentience, and where does it fail?

## Kuhn Review Anchor
- Section: 9.2.12. Northoff’s temporo-spatial sentience
- Pages: 25-25
- Taxonomy placement: Materialism theories -> Neurobiological theories -> Northoff’s temporo-spatial sentience
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Neurobiological theories -> Northoff’s temporo-spatial sentience.
...
## Related Packets
- Adjacent packets in Materialism theories -> Neurobiological theories -> Northoff’s temporo-spatial sentience
...
## Sources
- Kuhn review, section 9.2.12, pages 25-25.
