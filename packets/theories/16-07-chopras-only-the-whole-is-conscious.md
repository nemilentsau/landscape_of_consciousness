# Chopra’s only the whole is conscious

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Chopra’s only the whole is conscious, and where does it fail?

## Kuhn Review Anchor
- Section: 16.7. Chopra’s only the whole is conscious
- Pages: 100-100
- Taxonomy placement: Idealisms -> Chopra’s only the whole is conscious
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Idealisms -> Chopra’s only the whole is conscious.
...
## Related Packets
- Adjacent packets in Idealisms -> Chopra’s only the whole is conscious
...
## Sources
- Kuhn review, section 16.7, pages 100-100.
