...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Bohm’s implicate-explicate order, and where does it fail?

## Kuhn Review Anchor
- Section: 11.3. Bohm’s implicate-explicate order
- Pages: 64-64
- Taxonomy placement: Quantum theories -> Bohm’s implicate-explicate order
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Quantum theories -> Bohm’s implicate-explicate order.
...
## Related Packets
- Adjacent packets in Quantum theories -> Bohm’s implicate-explicate order
...
## Sources
- Kuhn review, section 11.3, pages 64-64.
