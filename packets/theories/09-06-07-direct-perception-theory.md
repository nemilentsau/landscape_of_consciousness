...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Direct perception theory, and where does it fail?

## Kuhn Review Anchor
- Section: 9.6.7. Direct perception theory
- Pages: 41-41
- Taxonomy placement: Materialism theories -> Embodied and enactive theories -> Direct perception theory
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Embodied and enactive theories -> Direct perception theory.
...
## Related Packets
- Adjacent packets in Materialism theories -> Embodied and enactive theories -> Direct perception theory
...
## Sources
- Kuhn review, section 9.6.7, pages 41-41.
