...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Dennett’s multiple drafts model, and where does it fail?

## Kuhn Review Anchor
- Section: 9.2.4. Dennett’s multiple drafts model
- Pages: 21-21
- Taxonomy placement: Materialism theories -> Neurobiological theories -> Dennett’s multiple drafts model
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Neurobiological theories -> Dennett’s multiple drafts model.
...
## Related Packets
- Adjacent packets in Materialism theories -> Neurobiological theories -> Dennett’s multiple drafts model
...
## Sources
- Kuhn review, section 9.2.4, pages 21-21.
