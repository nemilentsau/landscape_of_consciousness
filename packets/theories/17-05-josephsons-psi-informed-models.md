# Josephson ’ s psi-informed models

## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Josephson ’ s psi-informed models, and where does it fail?

## Kuhn Review Anchor
- Section: 17.5. Josephson ’ s psi-informed models
- Pages: 108-108
- Taxonomy placement: Anomalous and altered states theories -> Josephson ’ s psi-informed models
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Anomalous and altered states theories -> Josephson ’ s psi-informed models.
...
## Related Packets
- Adjacent packets in Anomalous and altered states theories -> Josephson ’ s psi-informed models
...
## Sources
- Kuhn review, section 17.5, pages 108-108.
