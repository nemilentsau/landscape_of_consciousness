...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Chalmers ’ s panpsychism, and where does it fail?

## Kuhn Review Anchor
- Section: 13.6. Chalmers ’ s panpsychism
- Pages: 74-74
- Taxonomy placement: Panpsychisms -> Chalmers ’ s panpsychism
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Panpsychisms -> Chalmers ’ s panpsychism.
...
## Related Packets
- Adjacent packets in Panpsychisms -> Chalmers ’ s panpsychism
...
## Sources
- Kuhn review, section 13.6, pages 74-74.
