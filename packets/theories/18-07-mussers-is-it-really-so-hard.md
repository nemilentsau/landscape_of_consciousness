...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Musser’s “is it really so hard?”, and where does it fail?

## Kuhn Review Anchor
- Section: 18.7. Musser’s “is it really so hard?”
- Pages: 119-119
- Taxonomy placement: Challenge theories -> Musser’s “is it really so hard?”
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Challenge theories -> Musser’s “is it really so hard?”.
...
## Related Packets
- Adjacent packets in Challenge theories -> Musser’s “is it really so hard?”
