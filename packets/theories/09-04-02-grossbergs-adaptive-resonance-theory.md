...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Grossberg ’ s adaptive resonance theory, and where does it fail?

## Kuhn Review Anchor
- Section: 9.4.2. Grossberg ’ s adaptive resonance theory
- Pages: 29-29
- Taxonomy placement: Materialism theories -> Computational and Informational Theories -> Grossberg ’ s adaptive resonance theory
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Computational and Informational Theories -> Grossberg ’ s adaptive resonance theory.
...
## Related Packets
- Adjacent packets in Materialism theories -> Computational and Informational Theories -> Grossberg ’ s adaptive resonance theory
...
## Sources
- Kuhn review, section 9.4.2, pages 29-29.
