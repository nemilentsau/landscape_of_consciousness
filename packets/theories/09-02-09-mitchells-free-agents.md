...
## Course Role
This packet supports a long-form listening-course episode on What is the strongest case for Mitchell’s free agents, and where does it fail?

## Kuhn Review Anchor
- Section: 9.2.9. Mitchell’s free agents
- Pages: 24-24
- Taxonomy placement: Materialism theories -> Neurobiological theories -> Mitchell’s free agents
...
## Cross-Examination
Compare this section with neighboring packets in the taxonomy path: Materialism theories -> Neurobiological theories -> Mitchell’s free agents.
...
## Related Packets
- Adjacent packets in Materialism theories -> Neurobiological theories -> Mitchell’s free agents
...
## Sources
- Kuhn review, section 9.2.9, pages 24-24.
